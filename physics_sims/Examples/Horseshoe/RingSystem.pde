...
class RingSystem {
  ...
  RingSystem() {
    ...
    moons.add(new Moon(G*5.3e21, 6.5e5, 151.422e6, color(0, 255, 0)));
    moons.add(new Moon(G*1.9e22, 1.02e6, 156.422e6, color(0, 0, 255)));
    moons.add(new Moon(G*1.9e22, 1.02e6, 156.422e6, color(0, 0, 255)));
    moons.add(new Moon(G*1.9e22, 1.02e6, 156.422e6, color(0, 0, 255)));
    moons.add(new Moon(G*1.9e22, 1.02e6, 156.422e6, color(0, 0, 255)));
    moons.add(new Moon(G*1.9e22, 1.02e6, 156.422e6, color(0, 0, 255)));
  ...
  void update() {
    ...
    for (Moon m : moons) {
      m.update(moons);
      //float KE = (1/2)*(m.GM/G)*sq(m.velocity.mag());
      //double PE = -(m.GM*(GMp/G))/m.position.mag();
      //println(PE);
