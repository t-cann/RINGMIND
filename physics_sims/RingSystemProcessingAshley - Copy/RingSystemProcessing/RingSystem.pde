...
class RingSystem {
  ...
  RingSystem() {
    ...
    case 1:
      ...
      rings.add(new Ring(5,1.1, 2.9, n_particles));
      break;
    case 2:
      //Saturn Ring Data (Source: Nasa Saturn Factsheet) [in Saturn radii]
      // D Ring: Inner 1.110 Outer 1.236
      rings.add(new Ring(0,1.110, 1.236, 1000));
      // C Ring: Inner 1.239 Outer 1.527
      rings.add(new Ring(1,1.239, 1.527, 1000));
      // B Ring: Inner 1.527 Outer 1.951
      rings.add(new Ring(2,1.527, 1.951, 1000));
      // A Ring: Inner 2.027 Outer 2.269
      rings.add(new Ring(3,2.027, 2.269, 5000));
      // F Ring: Inner 2.320 Outer *
      rings.add(new Ring(4,2.320, 2.321, 1000));
      // G Ring: Inner 2.754 Outer 2.874
      rings.add(new Ring(5,2.754, 2.874, 1000));
  ...
  void update() {
    ...
    //  r.update(moons);
    //  g.update(this);
    //  saveTable(g.gridToTable(g.grid), "input.csv");
    //}
